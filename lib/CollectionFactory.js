...
class PersistentCollection extends Collection{
	...
	async $save(options={}){
		...
		for(let model of this.$items){
			if((model.$isNew || !options.additionalPropertiesOnNewModelsOnly) && this.$collectionModelKeyName !== null && this.$collectionModelKeyValue !== null && !options.ownPropertiesOnly){
				options.additionalProperties = options.additionalProperties || {};
				options.additionalProperties[this.$collectionModelKeyName] = this.$collectionModelKeyValue;
			}
